...
def test_yolo_video(input_video_path, output_dir, model_name="yolov10n.pt", conf_threshold=0.5):
    ...
    print(f"Inizio elaborazione video: {input_video_path}")
...
if __name__ == "__main__":
    ...
    test_yolo_video(FILE_INPUT, OUTPUT_DIRECTORY, model_name="yolov10l.pt", conf_threshold=0.3)