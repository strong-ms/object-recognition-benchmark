...
target_path       = os.path.join(os.path.dirname(os.path.abspath(__file__)), "datasets", "AVA", "annotations", "ava_action_list_v2.2.pbtxt")
labelmap, _       = read_labelmap(target_path)
...
# ---------------------------------------------------------------
video_path = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "input", "video", "There are seven deadly sins, Captain.mp4"))
